...
class fesom_mesh:
	...
	def fesom_remove_pbnd(self):
		...
		self.nodes_2d_z  = np.concatenate((self.nodes_2d_z,self.nodes_2d_z[self.pbndn_2d_i  ]))
		self.nodes_2d_i  = np.concatenate((self.nodes_2d_i,self.nodes_2d_i[self.pbndn_2d_i  ]))
		self.nodes_2d_iz = np.concatenate((self.nodes_2d_iz,self.nodes_2d_iz[self.pbndn_2d_i]))
		...
		self.elem_2d_i = self.elem0_2d_i;
		...
		self.elem_2d_i = np.concatenate((self.elem0_2d_i,elem_pbnd_r))
	...
	def fesom_calc_triarea(self):
		...
		self.elem_2d_area = 0.5*np.abs(jacobian[0,0,:]*jacobian[1,1,:]-\
									   jacobian[0,1,:]*jacobian[1,0,:])
		self.elem_2d_area = np.concatenate((self.elem_2d_area,\
		...
		aux_area = self.elem_2d_area.reshape(self.elem_2d_area.size,1)
