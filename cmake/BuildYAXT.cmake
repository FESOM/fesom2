...
set(YAXT_CONFIGURE_COMMAND
    bash -c "cd <SOURCE_DIR> && autoreconf -iv && CC=${MPI_C_COMPILER} FC=${MPI_Fortran_COMPILER} CFLAGS=-fPIC FCFLAGS=-fPIC ./configure --prefix=${YAXT_INSTALL_PREFIX} --enable-shared --disable-static --without-regard-for-quality"
)
