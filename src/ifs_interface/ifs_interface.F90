...
SUBROUTINE nemogcmcoup_lim2_get( mype, npes, icomm, &
   ...
   !USE i_arrays, ONLY : m_ice, a_ice, m_snow ! aice, mice, msnow now in ice derived type
   ...
   integer, pointer :: myDim_nod2D, eDim_nod2D
   integer, pointer :: myDim_elem2D, eDim_elem2D, eXDim_elem2D
   real(kind=wpIFS), dimension(:)  , pointer ::  m_ice, a_ice, m_snow 
   ...
   a_ice(1:myDim_nod2D+eDim_nod2D)                            => fesom%ice%data(1)%values
   m_ice(1:myDim_nod2D+eDim_nod2D)                            => fesom%ice%data(2)%values
   m_snow(1:myDim_nod2D+eDim_nod2D)                           => fesom%ice%data(3)%values
