...
!           if (tr_arr(k,row,10)>0.001) then
!                print*,'scaling_density1_3D(k,row)= ',scaling_density1_3D(k,row)
!           end if

!           if (tr_arr(k,row,28)>0.001) then
!                print*,'scaling_density2_3D(k,row)= ',scaling_density2_3D(k,row)
!           end if
