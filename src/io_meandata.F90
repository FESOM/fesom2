...
CASE ('runoff_solid_ori  ')
  call def_stream(nod2D, myDim_nod2D, 'runoff_solid_ori',  'original solid water runoff',     'm/s',    ice%atmcoupl%runoff_solid_ori(:),        io_list(i)%freq, io_list(i)%unit, io_list(i)%precision, partit, mesh)
CASE ('enthalpy  ')
...
CASE ('enthalpy_ori  ')
  call def_stream(nod2D, myDim_nod2D, 'enth_ori',  'original enthalpy of fusion of solid water runoff',     'W/m^2',    ice%atmcoupl%enthalpyoffuse_ori(:),        io_list(i)%freq, io_list(i)%unit, io_list(i)%precision, partit, mesh)
CASE ('qcon      ')
