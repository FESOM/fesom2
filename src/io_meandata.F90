...
CASE ('tu        ')
    call def_stream((/nl-1, nod2D/),  (/nl-1, myDim_nod2D/),  'tu',      't*u',    'K*m/s',    tr_arr(:,:,2),             io_list(i)%freq, io_list(i)%unit, io_list(i)%precision, mesh)
CASE ('tv        ')
    call def_stream((/nl-1, nod2D/),  (/nl-1, myDim_nod2D/),  'tv',      't*v',    'K*m/s',    tr_arr(:,:,2),             io_list(i)%freq, io_list(i)%unit, io_list(i)%precision, mesh)
CASE ('tw        ')
    call def_stream((/nl-1, nod2D/),  (/nl-1, myDim_nod2D/),  'tw',      't*w',    'K*m/s',    tr_arr(:,:,2),             io_list(i)%freq, io_list(i)%unit, io_list(i)%precision, mesh)
CASE ('su        ')
    call def_stream((/nl-1, nod2D/),  (/nl-1, myDim_nod2D/),  'su',      's*u',    'psu*m/s',    tr_arr(:,:,2),             io_list(i)%freq, io_list(i)%unit, io_list(i)%precision, mesh)
CASE ('sv        ')
    call def_stream((/nl-1, nod2D/),  (/nl-1, myDim_nod2D/),  'sv',      's*v',    'psu*m/s',    tr_arr(:,:,2),             io_list(i)%freq, io_list(i)%unit, io_list(i)%precision, mesh)
CASE ('sw        ')
    call def_stream((/nl-1, nod2D/),  (/nl-1, myDim_nod2D/),  'sw',      's*w',    'psu*m/s',    tr_arr(:,:,2),             io_list(i)%freq, io_list(i)%unit, io_list(i)%precision, mesh)
CASE ('otracers  ')
    do j=3, num_tracers
