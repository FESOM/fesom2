...
!3D
  ...
  if (use_momix) then
    ...
    if (dynamics%diag_ke) then
       call def_stream((/nl-1, elem2D/), (/nl-1, myDim_elem2D/), 'ke_adv_u', 'work of advection   [u]',        'm2/s2', dynamics%ke_adv(1,:,:),  io_list(i)%freq, 'm', 8, partit, mesh)
       call def_stream((/nl-1, elem2D/), (/nl-1, myDim_elem2D/), 'ke_adv_v', 'work of advection   [v]',        'm2/s2', dynamics%ke_adv(2,:,:),  io_list(i)%freq, 'm', 8, partit, mesh)

       call def_stream((/nl-1, elem2D/), (/nl-1, myDim_elem2D/), 'ke_cor_u', 'work Coriolis  :)  [u]',         'm2/s2', dynamics%ke_cor(1,:,:),  io_list(i)%freq, 'm', 8, partit, mesh)
       call def_stream((/nl-1, elem2D/), (/nl-1, myDim_elem2D/), 'ke_cor_v', 'work Coriolis  :)  [v]',         'm2/s2', dynamics%ke_cor(2,:,:),  io_list(i)%freq, 'm', 8, partit, mesh)

       call def_stream((/nl-1, elem2D/), (/nl-1, myDim_elem2D/), 'ke_pre_u', 'work of pressure gradient  [x]', 'm2/s2', dynamics%ke_pre(1,:,:),  io_list(i)%freq, 'm', 8, partit, mesh)
       call def_stream((/nl-1, elem2D/), (/nl-1, myDim_elem2D/), 'ke_pre_v', 'work of pressure gradient  [y]', 'm2/s2', dynamics%ke_pre(2,:,:),  io_list(i)%freq, 'm', 8, partit, mesh)

       call def_stream((/nl-1, elem2D/), (/nl-1, myDim_elem2D/), 'ke_hvis_u', 'work of hor. visc. [x]',        'm2/s2', dynamics%ke_hvis(1,:,:), io_list(i)%freq, 'm', 8, partit, mesh)
       call def_stream((/nl-1, elem2D/), (/nl-1, myDim_elem2D/), 'ke_hvis_v', 'work of hor. visc. [y]',        'm2/s2', dynamics%ke_hvis(2,:,:), io_list(i)%freq, 'm', 8, partit, mesh)

       call def_stream((/nl-1, elem2D/), (/nl-1, myDim_elem2D/), 'ke_vvis_u', 'work of ver. visc. [x]',        'm2/s2', dynamics%ke_vvis(1,:,:), io_list(i)%freq, 'm', 8, partit, mesh)
       call def_stream((/nl-1, elem2D/), (/nl-1, myDim_elem2D/), 'ke_vvis_v', 'work of ver. visc. [y]',        'm2/s2', dynamics%ke_vvis(2,:,:), io_list(i)%freq, 'm', 8, partit, mesh)
