...
!3D
  if (ldiag_energy) then
     ...
     call def_stream((/nl-1, nod2D/),  (/nl-1,   myDim_nod2D/), 'tu',   'T times u', 'K*m/s', T_x_u(:,:), 1, 'm', i_real8, mesh)
     call def_stream((/nl-1, nod2D/),  (/nl-1,   myDim_nod2D/), 'tv',   'T times v', 'K*m/s', T_x_v(:,:), 1, 'm', i_real8, mesh)
     call def_stream((/nl-1, nod2D/),  (/nl-1,   myDim_nod2D/), 'su',   'S times u', 'psu*m/s', S_x_u(:,:), 1, 'm', i_real8, mesh)
     call def_stream((/nl-1, nod2D/),  (/nl-1,   myDim_nod2D/), 'sv',   'S times v', 'psu*m/s', S_x_v(:,:), 1, 'm', i_real8, mesh)
     call def_stream((/nl  , nod2D/),  (/nl  ,   myDim_nod2D/), 'tw',   'T times w', 'K*m/s', T_x_w(:,:), 1, 'm', i_real8, mesh)
     call def_stream((/nl  , nod2D/),  (/nl  ,   myDim_nod2D/), 'sw',   'S times w', 'psu*m/s', S_x_w(:,:), 1, 'm', i_real8, mesh)
