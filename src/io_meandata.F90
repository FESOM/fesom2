...
!___Global attributes________  
  ...
  call assert_nf( nf_put_att_text(entry%ncid, NF_GLOBAL, 'mesh representative checksum', len(mesh%representative_checksum), mesh%representative_checksum), __LINE__)
