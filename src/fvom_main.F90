...
!             write(*,*) 'FESOM step:',n,' day:', n*dt/24./3600.,
        ...
        if(use_ice) then
            ...
            !   hSv=0.1, L=30, lat0=47, lat1=65, lon0=-70, lon1=-40
            if (use_fw_forcing) call fw_forcing(fw_hsv, fw_lzon, fw_lat0, fw_lat1, fw_lon0, fw_lon1, mesh)
            !call fw_forcing(0.1, 20., 47., 65., -20., 0., mesh)            
        end if
