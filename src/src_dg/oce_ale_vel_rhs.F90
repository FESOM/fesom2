...
!write(*,*) mype, 'Step1', maxval(Unode_rhs(1,1,:)), minval(Unode_rhs(1,1,:))
...
!write(*,*) mype, 'Step2', maxval(Unode_rhs(1,1,:)), minval(Unode_rhs(1,1,:))
!write(*,*) mype, 'el2', maxval(edge_tri(2,:)), minval(edge_tri(2,:))
!write(*,*) mype, 'un1', maxval(un1(:)), minval(un1(:))
!write(*,*) mype, 'un2', maxval(un2(:)), minval(un2(:))
...
!write(*,*) mype, 'area_inv', maxval(area_inv(1,:)), minval((1,:))
!write(*,*) mype, 'Step3', maxval(Unode_rhs(1,1,:)), minval(Unode_rhs(1,1,:))
...
!do el=1, myDim_elem2D
!   nl1 = nlevels(el)-1
!   UV_adv(1:2,1:nl1,el) = UV_rhsAB(1:2,1:nl1,el) &
!        + elem_area(el)*(Unode_rhs(1:2,1:nl1,elem2D_nodes(1,el)) &
!        + Unode_rhs(1:2,1:nl1,elem2D_nodes(2,el)) & 
!        + Unode_rhs(1:2,1:nl1,elem2D_nodes(3,el))) / 3.0_WP
