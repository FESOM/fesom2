...
real(kind=WP), allocatable         :: UV_rhs(:,:,:), UV_rhsAB(:,:,:), UV_w_check(:,:,:), UV_pr_cor_check(:,:,:), UV_adv(:,:,:), e_t(:,:,:)
real(kind=WP), allocatable         :: uke(:,:), v_back(:,:), uke_back(:,:), uke_dis(:,:), uke_dif(:,:), uke_adv(:,:)
real(kind=WP), allocatable         :: uke_rhs(:,:), uke_rhs_old(:,:), EOF_check(:,:)
real(kind=WP), allocatable         :: UV_dis_tend(:,:,:), UV_back_tend(:,:,:), UV_total_tend(:,:,:), UV_dis_tend_node(:,:,:), uke_adv_tend(:,:)
real(kind=WP), allocatable         :: UV_dis_posdef_b2(:,:), UV_dis_posdef(:,:), UV_back_posdef(:,:)
real(kind=WP), allocatable         :: eta_n(:), d_eta(:), t_star(:), qsr_c(:), SB_EOF1(:), SB_l(:), SB_s(:), SB_PC1(:)

real(kind=WP), allocatable         :: SB_EOF2(:), SB_l2(:), SB_s2(:), SB_PC2(:)
real(kind=WP), allocatable         :: SB_EOF3(:), SB_l3(:), SB_s3(:), SB_PC3(:)
real(kind=WP), allocatable         :: SB_EOF4(:), SB_l4(:), SB_s4(:), SB_PC4(:)
real(kind=WP), allocatable         :: SB_EOF5(:), SB_l5(:), SB_s5(:), SB_PC5(:)
real(kind=WP), allocatable         :: SB_EOF6(:), SB_l6(:), SB_s6(:), SB_PC6(:)
real(kind=WP), allocatable         :: SB_EOF7(:), SB_l7(:), SB_s7(:), SB_PC7(:)
real(kind=WP), allocatable         :: SB_EOF8(:), SB_l8(:), SB_s8(:), SB_PC8(:)
real(kind=WP), allocatable         :: SB_EOF9(:), SB_l9(:), SB_s9(:), SB_PC9(:)
real(kind=WP), allocatable         :: SB_EOF10(:), SB_l10(:), SB_s10(:), SB_PC10(:)
real(kind=WP), allocatable         :: SB_EOF11(:), SB_l11(:), SB_s11(:), SB_PC11(:)
real(kind=WP), allocatable         :: SB_EOF12(:), SB_l12(:), SB_s12(:), SB_PC12(:)
real(kind=WP), allocatable         :: SB_EOF13(:), SB_l13(:), SB_s13(:), SB_PC13(:)
real(kind=WP), allocatable         :: SB_EOF14(:), SB_l14(:), SB_s14(:), SB_PC14(:)
real(kind=WP), allocatable         :: SB_EOF15(:), SB_l15(:), SB_s15(:), SB_PC15(:)
real(kind=WP), allocatable         :: SB_EOF16(:), SB_l16(:), SB_s16(:), SB_PC16(:)
real(kind=WP), allocatable         :: SB_EOF17(:), SB_l17(:), SB_s17(:), SB_PC17(:)
...
real(kind=WP), allocatable :: sw_3d(:,:)
