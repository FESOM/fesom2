...
#include "associate_mesh.h"
    ...
    !write(*,*) mype, 'c1', c1
    !write(*,*) mype, 'c2', c2
    !write(*,*) mype, 'ssh_rhs', maxval(ssh_rhs(:)), minval(ssh_rhs(:)) 
    !write(*,*) mype, 'U_rhs', maxval(UV_rhs(1,1,:)), minval(UV_rhs(1,1,:))
    !write(*,*) mype, 'U_rhs_AB', maxval(UV_rhsAB(1,1,:)), minval(UV_rhs(1,1,:))
    !write(*,*) mype, 'eta_n', maxval(eta_n(:)), minval(eta_n(:))
    !write(*,*) mype, 'w', maxval(Wvel(1,:)), minval(Wvel(1,:))
    !write(*,*) mype, 'u', maxval(UV(1,1,:)), minval(UV(1,1,:))
    !write(*,*) mype, 'hpressure', maxval(hpressure(1,:)), minval(hpressure(1,:))
    !write(*,*) mype, 'coriolis_node', maxval(coriolis_node(:)), minval(coriolis_node(:))
    !write(*,*) mype, 'elem_area', maxval(elem_area(:)), minval(elem_area(:))
    !write(*,*) mype, 'gradient_sca', maxval(gradient_sca(:,:)), minval(gradient_sca(:,:))
    !write(*,*) mype, 'vorticity', maxval(vorticity(1,:)), minval(vorticity(1,:))
    !write(*,*) mype, 'Z', maxval(Z(:)), minval(Z(:))
    
    
    !write(*,*) mype, 'UV_pr_cor_check', maxval(UV_pr_cor_check(1,1,:)), minval(UV_pr_cor_check(1,1,:))
    !write(*,*) mype, 'UV_w_check', maxval(UV_w_check(1,1,:)), minval(UV_w_check(1,1,:))
    
    !write(*,*) mype, 'V_rhs', maxval(UV_rhs(2,1,:)), minval(UV_rhs(2,1,:))
    !write(*,*) mype, 'U', maxval(UV(1,:,:)), minval(UV(1,:,:))
    !write(*,*) mype, 'V', maxval(UV(2,:,:)), minval(UV(2,:,:))
    !write(*,*) mype, 'deltaX1', deltaX1
    !write(*,*) mype, 'deltaY1', deltaY1
    !write(*,*) mype, 'alpha', alpha
    
    
    !write(*,*) mype, 'helem1', maxval(helem(:,1)), minval(helem(:,1))
    !write(*,*) mype, 'helem2', maxval(helem(:,1)), minval(helem(:,2))
    
    !write(*,*) mype, 'hbar', maxval(hbar(:)), minval(hbar(:))
    !write(*,*) mype, 'hbar_old', maxval(hbar_old(:)), minval(hbar_old(:))
    !write(*,*) n, 'hpressure', maxval(hpressure(:,:)), minval(hpressure(:,:))
    !write(*,*) mype, 'hnode', maxval(hnode(:,:)), minval(hnode(:,:))
    !write(*,*) n, 'gradient_sca', gradient_sca(1,1), gradient_sca(2,1), gradient_sca(3,1), gradient_sca(4,1), gradient_sca(5,1), gradient_sca(6,1)
