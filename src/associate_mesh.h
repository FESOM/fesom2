associate(nod2D=>mesh%nod2D, elem2D=>mesh%elem2D, edge2D=>mesh%edge2D, elem2D_nodes=>mesh%elem2D_nodes, elem_neighbors=>mesh%elem_neighbors, nod_in_elem2D_num=>mesh%nod_in_elem2D_num, &
          ...
          edge2D_in=>mesh%edge2D_in, area=>mesh%area, nlevels=>mesh%nlevels, ssh_stiff=>mesh%ssh_stiff, area_inv=>mesh%area_inv, mesh_resolution=>mesh%mesh_resolution, ocean_area=>mesh%ocean_area)
