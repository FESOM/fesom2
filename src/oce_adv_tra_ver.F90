...
#include "associate_mesh.h"
    ...
    do n=1,myDim_nod2D  
        ...
        b(1)= hnode_new(1,n)+W(1, n)*zinv-min(0._WP, W(2, n))*v_adv
        c(1)=-max(0._WP, W(2, n))*v_adv
        !_______________________________________________________________________
...
#include "associate_mesh.h"
    ...
    !$acc& private(nzmax,tvert,tv,dzjm1,dzj,dzjp1,dzjp2,deltaj,deltajp1,aL,aR,aj,x)&
...
#include "associate_mesh.h"
    ...
    do n=1, myDim_nod2D
        ...
        !_______________________________________________________________________
        ! Surface flux
        tvert(1)= -W(1,n)*(ttf(1,n)**do_Xmoment)*area(1,n)
        !_______________________________________________________________________
        ! Zero bottom flux
        tvert(nl1+1)=0.0_WP        
        !_______________________________________________________________________
        ...
        !_______________________________________________________________________
        flux(1:nl, n)=tvert(1:nl)-flux(1:nl, n)
    end do ! --> do n=1, myDim_nod2D
