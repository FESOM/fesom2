!> @file mod_mesh_utils.F90
!! @brief Mesh utility subroutines for FESOM mesh partitioner
!! @author Extracted from fvom_init.F90
!! @details Contains utility subroutines used by the FESOM mesh partitioner tool.
!! These subroutines were originally part of fvom_init.F90 but have been separated
!! into this module for better organization and to avoid compilation issues.
