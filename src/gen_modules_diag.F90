module diagnostics
  ...
  public :: ldiag_solver, lcurt_stress_surf, ldiag_Ri, ldiag_TurbFlux, ldiag_dMOC, ldiag_DVD,        &
            ldiag_forc, ldiag_salt3D, ldiag_trflx, ldiag_curl_vel3, diag_list, ldiag_vorticity,      &
            ldiag_extflds, compute_diagnostics, rhs_diag, curl_stress_surf, curl_vel3, shear, Ri,    & 
            KvdTdZ, KvdSdZ, tuv, suv, std_dens_min, std_dens_max, std_dens_N, std_dens,              &
