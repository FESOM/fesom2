...
!   integer,        parameter                      :: std_dens_N  =101
!   real(kind=WP),  save, target                   :: std_dens(std_dens_N)=(/ &
!                                                             0.0000,   30.00000, 30.55556, 31.11111, 31.36000, 31.66667, 31.91000, 32.22222, 32.46000, &
!                                                             32.77778, 33.01000, 33.33333, 33.56000, 33.88889, 34.11000, 34.44444, 34.62000, 35.00000, &
!                                                             35.05000, 35.10622, 35.20319, 35.29239, 35.37498, 35.41300, 35.45187, 35.52380, 35.59136, &
...
!                                                             36.39613, 36.42753, 36.45806, 36.48778, 36.51674, 36.54495, 36.57246, 36.59500, 36.59932, &
!                                                             36.62555, 36.65117, 36.67621, 36.68000, 36.70071, 36.72467, 36.74813, 36.75200, 36.77111, &
!                                                             36.79363, 36.81570, 36.83733, 36.85857, 36.87500, 36.87940, 36.88963, 36.89985, 36.90989, & 
!                                                             36.91993, 36.92979, 36.93965, 36.94935, 36.95904, 36.96856, 36.97808, 36.98745, 36.99682, &
!                                                             37.00603, 37.01524, 37.02430, 37.03336, 37.04228, 37.05119, 37.05997, 37.06874, 37.07738, &
!                                                             37.08602, 37.09453, 37.10303, 37.11979, 37.13630, 37.15257, 37.16861, 37.18441, 37.50000, &
!                                                             37.75000, 40.00000/)    
    integer,        parameter                      :: std_dens_N  =89
!   real(kind=WP),  save, target                   :: std_dens(std_dens_N)=(/ &
!                                                             0.00000, 30.00000, 30.55556, 31.11111, 31.36000, 31.66667, 31.91000, 32.22222, 32.46000, 32.77778,  &
!                                                             33.01000, 33.33333, 33.56000, 33.88889, 33.90080, 33.92731, 33.95685, 33.98976, 34.02495, 34.05949,  &
! 1str TRY                                                    34.09798, 34.14086, 34.18864, 34.24129, 34.29940, 34.36414, 34.43003, 34.49411, 34.56497, 34.63822,  &
!                                                             34.71963, 34.80967, 34.90627, 35.00937, 35.11729, 35.22742, 35.33702, 35.44261, 35.54283, 35.64036,  &
!                                                             35.71641, 35.78370, 35.84232, 35.88939, 35.93770, 35.97938, 36.02435, 36.06956, 36.11783, 36.16921,  &
!                                                             36.22360, 36.28237, 36.34333, 36.40694, 36.47381, 36.54251, 36.60999, 36.67583, 36.73629, 36.78790,  &
!                                                             36.83039, 36.86572, 36.89541, 36.92136, 36.93864, 36.95428, 36.96795, 36.97966, 36.99048, 37.00024,  &
!                                                             37.00889, 37.01690, 37.02418, 37.03014, 37.03518, 37.03908, 37.04354, 37.04849, 37.05256, 37.05713,  &
!                                                             37.06229, 37.06610, 37.06907, 37.07084, 37.07105, 37.07162, 37.07365, 37.80606, 40.00000/)                                                                
  real(kind=WP),  save, target                   :: std_dens(std_dens_N)=(/ &
                                                             0.00000, 29.50000, 30.00000, 30.55556, 31.11111, 31.36000, 31.66667, 31.91000, 32.22222, 32.46000,  &
...
!
  ...
  do elem=1, myDim_elem2D
     ...
     do nz=nzmax-1,nzmin,-1
        ...
        ! is upper binning index, for std_dens(jj) > dmin
        ! --> only check for density values dens(nz:nz+1)
        is=std_dens_N
        do jj = 1, std_dens_N
        ...
        ! ie lower binning index, countet from largest density level for
        ! std_dens(jj) < dmax) --> only check for density values dens(nz:nz+1)
        ie=1
        ...
        ! case when "ie" is larger than "is"
        if (ie-is > 0) then
