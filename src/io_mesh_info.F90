...
#include "associate_mesh_ass.h"
  ...
  call my_def_var(ncid, 'elements',          NF_INT,    2, (/elem_n_id, id_3/), elem_id,            'elements',                     partit)
  call my_def_var(ncid, 'nodes',             NF_DOUBLE, 2, (/nod_n_id,  id_2/), nod_id,             'nodal geo. coordinates',       partit)
  call my_def_var(ncid, 'nod_in_elem2D',     NF_INT,    2, (/nod_n_id, id_N/),  nod_in_elem2D_id,   'elements containing the node', partit)
  call my_def_var(ncid, 'edges',             NF_INT,    2, (/edge_n_id, id_2/), edges_id,           'edges',                        partit)
  call my_def_var(ncid, 'edge_tri',          NF_INT,    2, (/edge_n_id, id_2/), edge_tri_id,        'edge triangles',               partit)
...
!============================================================================
!
subroutine my_def_var(ncid, short_name, vtype, dsize, dids, id, att_text, partit)
IMPLICIT NONE
