...
character(20)                  :: which_pgf='shchepetkin' 
 ...
 NAMELIST /oce_dyn/ C_d, A_ver, laplacian, A_hor, A_hor_max, Leith_c, tau_c, Div_c, Smag_c, &
                    ...
                    Fer_GM, K_GM_max,K_GM_min,K_GM_bvref,K_GM_resscalorder, scaling_Ferreira, scaling_Rossby, scaling_resolution, scaling_FESOM14, & 
                    Redi, visc_sh_limit, mix_scheme, Ricr, concv, which_pgf, visc_option, easy_bs_scale, easy_bs_return
