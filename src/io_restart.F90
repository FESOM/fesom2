...
!!wiso-code!!!
  if (lwiso) then 
      call ini_wiso_io(yearnew, mesh)
  end if
!!wiso-code!!!
  if (use_ice) then
      call ini_ice_io  (yearnew, mesh)
  end if
#if defined(__icepack)
  if (use_ice) then
      call init_restart_icepack(yearnew, mesh)
  end if
#endif
  else
...
!!wiso-code!!!
  if (lwiso) then
      call ini_wiso_io(yearold, mesh)
  end if
!!wiso-code!!!
  if (use_ice) then
      call ini_ice_io  (yearold, mesh)
  end if
#if defined(__icepack)
  if (use_ice) then
      call init_restart_icepack(yearold, mesh)
  end if
#endif
  end if
