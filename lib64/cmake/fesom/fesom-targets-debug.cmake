...
set_target_properties(fesom PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib64/libfesom.so"
  IMPORTED_SONAME_DEBUG "libfesom.so"
  )

list(APPEND _cmake_import_check_targets fesom )
list(APPEND _cmake_import_check_files_for_fesom "${_IMPORT_PREFIX}/lib64/libfesom.so" )
...
set_target_properties(parms PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib64/libparms.so"
  IMPORTED_SONAME_DEBUG "libparms.so"
  )

list(APPEND _cmake_import_check_targets parms )
list(APPEND _cmake_import_check_files_for_parms "${_IMPORT_PREFIX}/lib64/libparms.so" )
...
list(APPEND _cmake_import_check_targets fesom.x )
list(APPEND _cmake_import_check_files_for_fesom.x "${_IMPORT_PREFIX}/bin/fesom.x" )
